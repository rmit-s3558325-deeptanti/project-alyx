...
<head>
  ...
  <title>Project Alyx | Delete Tours</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Delete Tours</li>
      </ol>
      
    </nav>
    <div class="welcome-msg pt-3 pb-4">
      <h1><span class="text-primary"><?php echo ucfirst(($_SESSION["type"])); ?></span> Dashboard - Delete Tours</h1>
      <p>You can delete the Tours from here. Be careful, changes made here cannot be reverted.</p>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-3 pr-sm-2 statistics-grid">
				<div class="card card_border border-primary-top p-4">
					...
					<input type="hidden" name="id" value="<?php echo $tours[$i][0]; ?>" />
