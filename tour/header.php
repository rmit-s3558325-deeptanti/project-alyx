    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list active">
          ...
          <ul class="sub-menu-list">
            <li><a href="add_tour.php">Add Tours </a> </li>
            <li><a href="edit_tour.php">Edit Tours </a> </li>
            <li><a href="delete_tour.php">Delete Tours </a> </li>
            <li><a href="add_tour_type.php">Add Tour Types </a> </li>
            <li><a href="edit_tour_type.php">Edit Tour Types </a> </li>
            <li><a href="delete_tour_type.php">Delete Tour Types </a> </li>
          </ul>
        </li>
