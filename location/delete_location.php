...
<head>
  ...
  <title>Project Alyx | Delete Locations</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Delete Locations</li>
      </ol>
      
    </nav>
    <div class="welcome-msg pt-3 pb-4">
      <h1><span class="text-primary"><?php echo ucfirst(($_SESSION["type"])); ?></span> Dashboard - Delete Locations</h1>
      <p>You can delete the Locations from here. Be careful, changes made here cannot be reverted.</p>
    </div>
